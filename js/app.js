...
import { sessaoAtiva, encerrarSessao } from './auth.js'
...
export function atualizarHeader(titulo, subtitulo = '') {
  ...
  h.innerHTML = `
    ...
    <button id="btn-lock" class="btn-lock" title="Bloquear app" onclick="import('./auth.js').then(a => { a.encerrarSessao(); location.reload() })">
